...
#% June 15, 2023 & University of North Dakota 
...
#
Eorb = [2.524372,  2.524372, 2.524372, 1.397442, -0.914148] # molecular orbital energies
EN   = -2.855160477243
...
for line in open('He_tei_data_cc_pvdz.txt'):
...
ECCSD = 0
DECC = 1.0
while DECC > 1e-10: # arbitrary convergence criteria
  OLDCC = ECCSD
