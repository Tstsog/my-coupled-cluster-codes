% This Matlab code computes  the ground state energy for helium atom from the Coupled Cluster Singles and Doubles (CCSD) method 
...
% two-electron integral (He_tei_data_gto_n5.txt) data was obtained from the SCF calculation.  
%
...
%
function [] = ccsd_he_gto_n5
%
clear; clc; format long
%
dim2B = 10; % size of spin-orbital basis
tol = 1e-10;
%
tei_n = 120;  % total number of the unique TEI. 
%
read_tei_data = fopen('He_tei_data_gto_n5.txt', 'r');
...
%
E0 =  -2.859894932681;                                          % the SCf ground state energy
En_orb = [171.602444, 26.364991, 5.186112 , 0.814206, -0.916869];  % An orbital energies
%
fs = kron(diag(En_orb), eye(2)); % Fock matrix elements in molecular spin-orbital basis sets
%
holes = [10, 9]; % hole states
particles  = [8, 7, 6, 5, 4, 3, 2, 1]; % virtial (particle) states 
%
...
[E0, En_ccsd] % [-2.859894932681000  -2.876953999082675]
