...
% using the Gaussian-type orbital (GTO) with n=2 (2 s-function)
%
...
%
function [] = ccsd_he_gto_n2
%
clear; clc; format long
%
dim2B = 4; % size of spin-orbital basis
tol = 1e-10;
%
tei_n = 6;  % total number of the unique TEI. 
%
read_tei_data = fopen('He_tei_data_gto_n2.txt', 'r');
...
%
E0 =  -2.747066128455;                                          % the SCf ground state energy
En_orb = [3.856151, -0.858910];  % An orbital energies
%
fs = kron(diag(En_orb), eye(2)); % Fock matrix elements in molecular spin-orbital basis sets
%
holes = [4, 3]; % hole states
particles  = [2, 1]; % virtial (particle) states 
%
...
[E0, En_ccsd]  % [-2.747066128455000  -2.757790335167034]
