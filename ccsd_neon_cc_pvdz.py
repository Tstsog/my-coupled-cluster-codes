...
#% June 16, 2023 & University of North Dakota 
...
#1st state
holes = [27, 26, 25, 24, 11, 10, 7, 6, 3, 2]
particles = [23, 22, 21, 20, 19, 18, 17, 16, 15, 14, 13, 12, 9, 8, 5, 4, 1, 0]
#
Eorb = [1.694558, -0.832097,  
        1.694558, -0.832097, 
        1.694558, -0.832097, 
...
for line in open('Ne_tei_data_cc_pvdz.txt'):
