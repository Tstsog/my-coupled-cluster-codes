...
Nelec = 2 # we have 2 electrons in He
dim = 2 # we have two spatial basis functions in two GTO basis set

####################################################

dim1B = 4 #% size of spin-orbital basis 

#1st state
holes = [3, 2]
particles = [1, 0]
#
Eorb = [3.856151, -0.858910] # molecular orbital energies
EN   = -2.747066128455
...
for line in open('He_tei_data_gto_n2.txt'):
